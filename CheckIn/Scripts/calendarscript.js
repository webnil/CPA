...
function updateEvent(event, element) {
    ...
    $("#eventPurpose").val(event.purpose);
    $("#eventContactNumber").val(event.contactNumber);
        ...
        $('#calendar').fullCalendar('renderEvent',
						{
						    ...
						    purpose: $("#addEventPurpose").val(),
						    contactNumber: $("#addEventContactNumber").val(),
						    allDay: globalAllDay
						},
        ...
        buttons: {
            "Update Appointment": function () {
                ...
                if (checkForSpecialChars(eventToUpdate.title) || checkForSpecialChars(eventToUpdate.description)) {
                    ...
                    currentUpdateEvent.purpose = $("#eventPurpose").val();
                    debugger;
                    currentUpdateEvent.contactNumber = $("#eventContactNumber").val();
