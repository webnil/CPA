...
namespace CheckIn.CPA
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        private void RefreshSearchResult()
        {
            ...
            var result =BusinessLogic.GetAllScheduledAppointmentForCustomer(int.Parse(userId));
        ...
        private void FillAllAppointmentsForCurrentWeek(GridViewRowEventArgs e)
        {
            ...
            //if (cpaID != null)// && tempDate != null)
            {
                ...
                //DataSet result = BusinessLogic.GetSCheduleCPACustomerDetails2(cpaID.Text, userId);
                DataSet result = BusinessLogic.GetSCheduleCPACustomerDetails2( userId);
